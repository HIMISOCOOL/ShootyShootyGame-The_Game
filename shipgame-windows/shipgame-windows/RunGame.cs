...
namespace shipgame_windows// Shooty shooty game the game
{
    ...
    public class RunGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            bgLayer2.Initialize(Content, "Graphics\\bgLayer2", GraphicsDevice.Viewport.Width, GraphicsDevice.Viewport.Height, 1);
        ...
        private void UpdateMines(GameTime gameTime)
        {
            ...
            if (random.NextDouble() < BlockSpawnProbability)
            {
                ...
                if (next == 1)
                {
                    ...
                    (GraphicsDevice.Viewport.TitleSafeArea.Width - mineSpriteSheet.Width / 8);
                    Mines.Add(new Mine(mineAnimation, mineTexture, new Vector2(x, -mineSpriteSheet.Height)));
                }
                if (next == 2)
                {
                    float y = (float)random.NextDouble() *
                    (GraphicsDevice.Viewport.TitleSafeArea.Height - mineSpriteSheet.Height);
        ...
        private void UpdatePlayer(GameTime gameTime, Player player)
        {
            ...
            player.Position.X = MathHelper.Clamp(player.Position.X, player.HitBox.Width, GraphicsDevice.Viewport.Width);
            player.Position.Y = MathHelper.Clamp(player.Position.Y, player.HitBox.Height, GraphicsDevice.Viewport.Height);
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, "Hit: "+hit, new Vector2(100, GraphicsDevice.Viewport.TitleSafeArea.Y + GraphicsDevice.Viewport.TitleSafeArea.Height / 2),Color.Black, 0, Vector2.Zero, 1.0f, SpriteEffects.None,0f);
            spriteBatch.DrawString(font, "Keyboard: " + players[0].Keyboard, new Vector2(100, (GraphicsDevice.Viewport.TitleSafeArea.Y + GraphicsDevice.Viewport.TitleSafeArea.Height / 2)+25), Color.Black, 0, Vector2.Zero, 1.0f, SpriteEffects.None, 0f);
